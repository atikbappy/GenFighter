...
def attack_process(attacker, victim : Victim, data, limit):
    ...
    ori_x_prob, adv_x_prob = None, None
    
    try:
        adversarial_sample, ori_x_prob, adv_x_prob = attacker(victim, data)
    ...
    return adversarial_sample, attack_time, invoke_times, ori_x_prob, adv_x_prob
